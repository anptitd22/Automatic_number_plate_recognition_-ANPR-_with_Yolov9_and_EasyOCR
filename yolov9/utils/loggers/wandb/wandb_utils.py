...
class WandbLogger():
    """Log training runs, datasets, model, and predictions to Weights & Biases.
    ...
    model and predictions can also be logged.
    ...
    def setup_training(self, opt):
        """
        Setup the necessary processes for training YOLO model:
