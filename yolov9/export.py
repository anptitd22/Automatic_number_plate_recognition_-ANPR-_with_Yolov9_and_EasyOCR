...
def add_tflite_metadata(file, metadata, num_outputs):
    # Add metadata to *.tflite model per https://www.tensorflow.org/lite/models/convert/metadata
...
def run(
    ...
    if any((saved_model, pb, tflite, edgetpu, tfjs)):  # TensorFlow formats
        assert not tflite or not tfjs, 'TFLite and TF.js model must be exported separately, please pass only one type.'
